      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
          ...
          <div className="flex flex-col gap-4">
            ...
            <p className="text-xs text-soft-gray font-light leading-relaxed mt-2">
              Bespoke luxury bridal and high-fashion editorial makeup artist
              crafting luminous glass skin transformations inside Delhi,
              Noida NCR, and globally for destination wedding events.
            </p>
            ...
            <ul className="flex flex-col gap-3">
              {[
                ...
                <li key={link.name}>
                  ...
                  >
                    <ArrowRight className="w-3 h-3 text-burgundy-light group-hover:text-gold" />
                    {link.name}
                  </Link>
                </li>
              ))}
        ...
        <div className="border-t border-burgundy/10 pt-8 flex flex-col md:flex-row items-center justify-between gap-4 text-[10px] sm:text-xs text-soft-gray/70">
          ...
          <div className="flex flex-col md:flex-row items-center gap-2">
            ...
            <span className="hidden md:block text-burgundy/30">|</span>

            <a
              href="https://umanztechnology.in"
              target="_blank"
              rel="noopener noreferrer"
              className="font-semibold text-gold hover:text-white transition-all duration-300"
            >
              Designed by Umanz Technology
            </a>
